...
// TODO:HTMLインポートで追加登録したパネルが上方に並ぶため、大量にあると新規ブックマーク入力欄が
// 画面下に消えてどこにいったかわからない問題。追加登録パネル群は下方に並んだ方がよい。
...
// パネルタイトル(フォルダ名)欄のhoverで、右側(か左側)に中身ボックスが表示されるのがいいんじゃないか？
// 全部のパネルを閉じても１画面に収まらないほど大量の時は、下に中身が出るより使いやすそうな気がする。
